...
<p>
<?php __('To change the content of this page, create: /app/views/pages/home.ctp.'); ?><div class="pad15"></div>
<?php __('To change its layout, create: /app/views/layouts/default.ctp.'); ?><div class="pad15"></div>
<a href="http://manual.cakephp.org/"><?php __('See the views section of the manual for more info.'); ?> </a><div class="pad15"></div>
<?php __('You can also add some CSS styles for your pages at: app/webroot/css/.'); ?>
</p>
<h2><?php __('Getting Started'); ?></h2>
<p>
<a href="http://manual.cakephp.org/appendix/blog_tutorial"><?php __('The 15 min Blog Tutorial'); ?></a><div class="pad15"></div>
<a href="http://www-128.ibm.com/developerworks/edu/os-dw-os-php-cake1.html"><?php __('Cook up Web sites fast with CakePHP'); ?></a><div class="pad15"></div>
