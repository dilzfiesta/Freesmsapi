...
<div class="header_07"><span>Please feel free to send us your comments or suggesstions.</span></div>

<form method="post">
	<div class="pad5">
		<span><textarea name="data[Feedback][feedback]" class="textbox"><?=isset($feedbackText)?$feedbackText:''?></textarea></span>
	</div>
